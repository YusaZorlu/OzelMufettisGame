...
public class IstEpTwo extends AppCompatActivity {
    int upCount;
    int midCount;
    TextView upL;
    TextView midL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ist_ep_two);
        doBindService();
        ...
        upL.setText("Keşfedilen Mekanlar: "+upCount+"/6");
        midL.setText("Keşfedilen Şüpheliler: "+midCount+"/7");
    }
    ...
    public void toBlame(View view){
        Intent intent = new Intent(getApplicationContext(), IstEpTwoBlame.class);
        startActivity(intent);
    }
    public void toInvestigate(View view){
        Intent intent = new Intent(getApplicationContext(), IstEpTwoInvestigate.class);
        startActivity(intent);
    }
    public void toQuestioning(View view){
        Intent intent = new Intent(getApplicationContext(), IstEpTwoQuestioning.class);
        startActivity(intent);
    }
